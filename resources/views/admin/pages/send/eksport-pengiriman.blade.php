...
<div>
    <div class="card mb-8">
        <div class="card-header flex flex-row justify-between">
            <h1 class="h6">Export Riwayat Pengiriman</h1>
        </div>
      <hr class="h-px mt-0 bg-transparent bg-gradient-horizontal-dark">
      <form method="POST" enctype="multipart/form-data" action="{{url('/back-admin/pengiriman/download')}}">
          @csrf
          <div class="p-0 mt-3 p-4 overflow-x-auto">
            <div class="mt-3">
